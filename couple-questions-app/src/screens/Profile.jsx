...
const T = {
  ru: {
    ...
    privacy: "Приватность",
    privacyNote: "Скрытые темы не увидит никто из ваших связей, даже если вы оба ответили.",
    hidden: "скрыт",
    visible: "виден",
    premiumOn: "Доступ открыт. Все темы, связи без ограничений и разбор от ИИ.",
    premiumOff: "Все 11 тем, сколько угодно связей и разбор от ИИ. Платит один — открывается обоим.",
