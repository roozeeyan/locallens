    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          ...
          "Настройки: язык, оформление, частота напоминаний, скрытые блоки, статус.",
  ...
  ru: {
    ...
    sections: [
      ...
      },
      {
        h: "Платный доступ",
        p: [
          "Часть блоков открывается платно. Оплата проходит через Telegram Stars по правилам Telegram.",
